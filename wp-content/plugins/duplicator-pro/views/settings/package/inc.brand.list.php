        ...
        <tr id='main-view-<?php echo $brands[0]->id; ?>' class="brand-row">
            ...
            <td>
                ...
                <div class="sub-menu">
                    ...
                    <a href="<?php echo get_admin_url(null, "admin.php?page=duplicator-pro-settings&tab=package&sub=brand&made_active=true&id=" . $brands[0]->id ); ?>" style="color:orangered;"><?php DUP_PRO_U::esc_html_e('Set active'); ?></a>
                    <?php endif; ?>
                </div>
            </td>
            <td>
