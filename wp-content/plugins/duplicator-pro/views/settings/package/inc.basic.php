	...
	<td>
		...
		<div class="engine-sub-opts" id="dbengine-details-1" style="display:none">
			...
			<?php if (! $is_shellexec_on) : ?>
				...
				<div class="dup-feature-notfound">
					<?php
						DUP_PRO_U::esc_html_e("In order to use mysqldump the PHP function shell_exec needs to be enabled. This server currently does not allow "
							. "<a href='http://php.net/manual/en/function.shell-exec.php' target='_blank'>shell_exec</a> to run. ");
						DUP_PRO_U::esc_html_e("Please contact your host or server admin to enable this feature. For a list of approved providers that support shell_exec ");
